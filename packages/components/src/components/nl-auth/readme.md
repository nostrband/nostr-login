...
| `createConnectionString` | --                     |             | `{ name: string; img: string; link: string; }[]`           | `[     {       name: 'Nsec.app',       img: 'https://nsec.app/assets/favicon.ico',       link: 'https://nsec.app',     },     {       name: 'Amber',       img: 'https://raw.githubusercontent.com/greenart7c3/Amber/master/app/src/main/res/mipmap-hdpi/ic_launcher.webp',       link: 'https://nsec.app',     },     {       name: 'Other key store',       img: '',       link: 'https://nsec.app',     },   ]` |
